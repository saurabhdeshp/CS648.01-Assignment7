...
firstCalcNumber = parseFloat(window.prompt("Addition of three numbers: \nEnter first number:"));
secondCalcNumber = parseFloat(window.prompt("Addition of three numbers: \nEnter second number:"));
thirdCalcNumber = parseFloat(window.prompt("Addition of three numbers: \nEnter third number:"));
